...
- Para trabajar en el código, entrar en el subdirectorio correspondiente (`ios/`, `pruebas-gtfs/`, etc.) y operar sobre
  su repositorio Git propio.
